...
public interface ContactDAO {
  ...
  /**
   * Creates a new contact with the given status, year, user ID, and enterprise
   * ID.
   *
   ...
   * @return A ContactDTO object representing the contact information, or null if
   *         no contact is
   ...
   * @return The updated ContactDTO object representing the contact with the new
   *         information.
